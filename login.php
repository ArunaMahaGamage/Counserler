...
if (isset($_POST['btn-login'])) {
    ...
    /* $email = $DBcon->real_escape_string($email);
      $password = $DBcon->real_escape_string($password);
     */
    $query = $DBcon->query("SELECT Username, Password, Activation,type FROM login WHERE Username='$username'");
    ...
    if ($password == $row['Password']) {
        if ($row['Activation'] == 1) {
            ...
            $msg = "<div class='alert alert-danger'>
					<span class='glyphicon glyphicon-info-sign'></span> &nbsp;Your Account has not been activated!
				</div>";
        }
    } else {
        $msg = "<div class='alert alert-danger'>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
       ...
       <style>         body {
    background-image: url("imge/478.jpg");
                                ...
                                <a class="navbar-brand" href="#"><h1><font color="sky blue">UPAKARA</font></h1></a>
                                        ...
                                        <div id="navbar" class="navbar-collapse collapse">
                                            ...
                                            <ul class="nav navbar-nav navbar-right">
                                                <li class="active"><a href="login.php"><font color="black">Login</font></a></li>
                        ...
                        <div class="container">
                            ...
                            <form class="form-signin" method="post" id="login-form">
                                ...
                                <div class="form-group">
                                    ...
                                    <a href="coun_register.html" class="btn btn-default" style="float:right;">counselor Register </a>
                                    <br><br><div><a href="forgotPassword.php">Forgot password?</a>
                                    </div>
