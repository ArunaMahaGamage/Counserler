    ...
    <head>
        ...
        <link href="bootstrap/css/bootstrap.min.css" rel="stylesheet" media="screen"> 
            ...
            <link href="bootstrap/css/bootstrap-theme.min.css" rel="stylesheet" media="screen">
                ...
                <style>         body {
                        background-image: url("imge/dx.jpg");
                                                                    ...
                                                                    <div class="container" style="margin-top: 50px;" >
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="container">
                                                                                ...
                                                                                <div class="panel panel-default">
                                                                                    ...
                                                                                    <div class="panel-body">
                                                                                        ...
                                                                                        $sql = "SELECT * FROM counsellor where Counsellor_ID=" . 'Counsellor_ID';
                                                                                        $result = mysqli_query($conn, $sql);
                                                                                        if ($row = mysqli_fetch_assoc($result)) {

                                                                                            echo $row['Counsellor_ID'] . '<br>';
                                                                                            echo $row['Title'] . '<br>';
                                                                            ...
                                                                            <div>
                                                                                ...
                                                                                <div>  <form action="timetable.html">
                                                                                        <button type="submit">Update Time table</button></div><br>
                                                                                    </form>
                                                                                    <div>  <form action="resources.php.html">
                                                                                            <button type="submit">Upload resources</button></div><br>
                                                                                        </form>
                                                                                        <div>  <form action="showsession.php">
                                                                                                <button type="submit">session form</button></div>
                                                                                        </form>
