...
<style>         body {
    background-image: url("imge/34.jpg");
       ...
       <form class="form-signin" method="post" id="register-form">
        ...
        <div class="form-group">
            <button type="submit" class="btn btn-default" name="btn-signup">
                <a href="coun_register.html" class="btn btn-default" style="float:right;"><span class="glyphicon glyphicon-log-in"></span> &nbsp; Create Account</a>
			</button> 
