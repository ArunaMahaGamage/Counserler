...
Check whether your sessionform confirmed or not.
                                         <?php
...
$sql = "SELECT * FROM sessionform GET status='Confirmed' WHERE UserID=" . 'UserId';

$result = $conn->query($sql);

if ($result->num_rows > 0) {
    echo "<table><tr><th>ID</th><th>Name</th><th>Type</th><th>Date</th><th>From</th><th>To</th><th>Counsellor_ID</th></tr>";
    // output data of each row
    while($row = $result->fetch_assoc()) {
       echo "<tr><td>".$row["Session_form_ID"]."</td><td>".$row["First_name"]." ".$row["Last_name"]."</td><td>".$row["Type"]."</td><td>".$row["Date"]."</td><td>".$row["From"]."</td><td>".$row["To"]."</td><td>".$row["Counsellor_ID"]."</td>
                                </tr>";
    echo "</table>";
} else {
    echo "0 results";
                                    ...
                                    <br><br><br><br>
                                                                                                                                                                                                ...
                                                                                                                                                                                                <footer class="footer">
                                                                                                                                                                                                    <div class="container">
                                                                                                                                                                                                        ...
                                                                                                                                                                                                        <span class="col-sm-1"><a href="contact_us.html">contact us</a></span>

                                                                                                                                                                                                        <span class="col-sm-1"><a href="user_register.html">For User</a></span>
                                                                                                                                                                                                        <span class="col-sm-1"> <a href="coun_register.html">For Counselors</a></span>


                                                                                                                                                                                                        <span class="col-sm-1"> <a href="">Terms &amp; Conditions</a></span>
                                                                                                                                                                                                        <span class="col-sm-1">  <a href="/privacy/">Privacy Policy</a></span>
